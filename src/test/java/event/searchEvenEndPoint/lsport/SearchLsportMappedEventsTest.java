...
public class SearchLsportMappedEventsTest {
    ...
    public SearchLsportMappedEventsTest() throws SQLException {
    }

    final EventModel GET_ALL_STATUS_EVENT_MODEL = eventDAO.getLsportMappedEventsWithAllStatusFromDB();
    final EventModel GET_NOT_STARTED_STATUS_EVENT_MODEL = eventDAO.getLsportMappedEventsWithNotStartedStatusWithoutOutrightFromDB();
    final EventModel GET_OUTRIGHT_NOT_STARTED_STATUS_EVENT_MODEL = eventDAO.getLsportMappedEventsWithNotStartedStatusWithOutrightFromDB();
    final EventModel GET_LIVE_STATUS_EVENT_MODEL = eventDAO.getLsportMappedEventsWithLiveStatusFromDB();
    final EventModel GET_FINISHED_STATUS_EVENT_MODEL = eventDAO.getLsportMappedEventsWithFinishedStatusWithoutOutrightFromDB();
    final EventModel GET_OUTRIGHT_FINISHED_STATUS_EVENT_MODEL = eventDAO.getLsportMappedEventsWithFinishedStatusWithOutrightFromDB();
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright FALSE by sportId")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright FALSE by categoryId")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright FALSE by tournamentId")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright FALSE by name event")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright FALSE by mappedId")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright FALSE by sportId and categoryId")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright FALSE by sportId, categoryId, tournamentId")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright FALSE by sportId, categoryId, tournamentId, name")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright TRUE by sportId")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright TRUE by categoryId")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright TRUE by tournamentId")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright TRUE by name event")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright TRUE by mappedId")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright TRUE by sportId and categoryId")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright TRUE by sportId, categoryId, tournamentId")
    ...
    @Test(testName = "Search mapped event with NOT_STARTED status and outright TRUE by sportId, categoryId, tournamentId, name")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright FALSE by sportId")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright FALSE by categoryId")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright FALSE by tournamentId")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright FALSE by name event")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright FALSE by mappedId")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright FALSE by sportId and categoryId")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright FALSE by sportId, categoryId, tournamentId")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright FALSE by sportId, categoryId, tournamentId, name")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright TRUE by sportId")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright TRUE by categoryId")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright TRUE by tournamentId")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright TRUE by name event")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright TRUE by mappedId")
    public void search_OutrightEventByFinishedStatusAndMappedIdEvent() {
        Specifications.installSpecifications(Specifications.requestSpec(), Specifications.responseSpec200());
        SearchEventRequest postRequest = new SearchEventRequest.EventBuilderImpl()
                .setMapped(true)
                .setMappedId(GET_OUTRIGHT_FINISHED_STATUS_EVENT_MODEL.getMapped_id())
                .setProvider(GET_OUTRIGHT_FINISHED_STATUS_EVENT_MODEL.getProvider())
                .setStatus(GET_OUTRIGHT_FINISHED_STATUS_EVENT_MODEL.getStatus())
                .setOutright(GET_OUTRIGHT_FINISHED_STATUS_EVENT_MODEL.getOutright())
                .build();
        ...
        Assert.assertNotNull(response);
        Assert.assertTrue(response.getData().stream().allMatch(dataType -> Objects
                .equals(dataType.getMappedId(), GET_OUTRIGHT_FINISHED_STATUS_EVENT_MODEL.getMapped_id())));
        Assert.assertTrue(response.getData().stream().allMatch(dataType -> Objects
                .equals(dataType.getProvider()
                        , GET_OUTRIGHT_FINISHED_STATUS_EVENT_MODEL.getProvider())));
        Assert.assertTrue(response.getData().stream().allMatch(dataType -> Objects
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright TRUE by sportId and categoryId")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright TRUE by sportId, categoryId, tournamentId")
    ...
    @Test(testName = "Search mapped event with FINISHED status and outright TRUE by sportId, categoryId, tournamentId, name")
