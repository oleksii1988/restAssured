...
public class SearchLongshotUnmappedEventsTest {

    private static final String URL_ENDPOINT = "/event:search";

    EventDAO eventDAO = new EventDAO();

    public SearchLongshotUnmappedEventsTest() throws SQLException {
    }

    final EventModel GET_ALL_STATUS_EVENT_MODEL = eventDAO.getLongShotUnmappedEventsWithAllStatusFromDB();
    final EventModel GET_NOT_STARTED_STATUS_EVENT_MODEL = eventDAO.getLongShotUnmappedEventsWithNotStartedStatusFromDB();
    final EventModel GET_LIVE_STATUS_EVENT_MODEL = eventDAO.getLongShotUnmappedEventsWithLiveStatusFromDB();
    final EventModel GET_FINISHED_STATUS_EVENT_MODEL = eventDAO.getLongShotUnmappedEventsWithFinishedStatusFromDB();
    ...
    @Test(testName = "Search unmapped event with NOT_STARTED status by sportId")
    ...
    @Test(testName = "Search unmapped event with NOT_STARTED status by categoryId")
    ...
    @Test(testName = "Search unmapped event with NOT_STARTED status by tournamentId")
    ...
    @Test(testName = "Search unmapped event with NOT_STARTED status by name event")
    ...
    @Test(testName = "Search unmapped event with NOT_STARTED status by sportId and categoryId")
    ...
    @Test(testName = "Search unmapped event with NOT_STARTED status by sportId, categoryId, tournamentId")
    ...
    @Test(testName = "Search unmapped event with NOT_STARTED status by sportId, categoryId, tournamentId, name")
    ...
    @Test(testName = "Search unmapped event with FINISHED status by sportId")
    ...
    @Test(testName = "Search unmapped event with FINISHED status by categoryId")
    ...
    @Test(testName = "Search unmapped event with FINISHED status by tournamentId")
    ...
    @Test(testName = "Search unmapped event with FINISHED status by name event")
    ...
    @Test(testName = "Search unmapped event with FINISHED status by sportId and categoryId")
    ...
    @Test(testName = "Search unmapped event with FINISHED status by sportId, categoryId, tournamentId")
    ...
    @Test(testName = "Search unmapped event with FINISHED status by sportId, categoryId, tournamentId, name")
